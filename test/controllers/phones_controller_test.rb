...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference("Phone.count") do
      post phones_url, params: { phone: { comment: @phone.comment, people_id: @phone.people_id, phone_number: @phone.phone_number } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { comment: @phone.comment, people_id: @phone.people_id, phone_number: @phone.phone_number } }
